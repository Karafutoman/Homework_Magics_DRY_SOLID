...
Класс Purchase нарушает принцип единственной ответственности (single responsiblity principle), являясь одновременно покупкой и корзиной.
Решением этого наоушения будет разделение их на два класса с добавлением класс Basket.

Указание размера массива при инициализации точного числа 4 - нарушение.
protected Purchase[] purchases = new Purchase[4];

Решение изменяем мапу товаров и цен в конструктор.
...
в классе Main вносим изменим с учетом разделения класса Purchase на Purchase и Basket.
